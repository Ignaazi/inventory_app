  ...
  <div class="custom-scroll-container flex flex-col overflow-y-auto duration-300 ease-linear grow">
    <nav class="px-4 py-6">
      ...
      <ul class="flex flex-col gap-1.5">
        ...
        <li class="relative">
          {{-- 🌟 UPDATE: Ditambahkan '*eng/return*' agar tombol utama aktif saat membuka menu return --}}
          <button 
          ...
          <ul x-show="openMenu === 'trans'" x-transition :class="(sidebarToggle && window.innerWidth >= 1024) ? 'sidebar-mini-floating' : 'mt-1 ml-9 border-l border-slate-100 dark:border-slate-800'" class="flex flex-col gap-1">
            ...
            {{-- 🌟 BARU: Menu Return disisipkan rapi di antara Out dan Disposal --}}
            <li>
      ...
      <div class="mb-8" x-data="{ 
        ...
        <ul class="flex flex-col gap-1.5">
          ...
          <li>
            <a href="{{ route('prod.line.index') }}" 
               class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*prod/list-line-production*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
                <svg class="siix-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
