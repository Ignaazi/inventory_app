  ...
  <div class="custom-scroll-container flex flex-col overflow-y-auto duration-300 ease-linear grow">
    <nav class="px-4 py-6">
      ...
      <div class="mb-8" x-data="{ 
        openMenu: '{{ request()->is('*eng/in*', '*eng/out*', '*eng/disposal*') ? 'trans' : (request()->is('*barcode*', '*parsing*', '*type*') ? 'barcode' : (request()->is('*eng/approval*', '*approval/history*') ? 'approval' : 'none')) }}'
      }">
        ...
        <ul class="flex flex-col gap-1.5">
          <li>
            <a href="/eng/overview" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*eng/overview*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li>
            <a href="/eng/list-sparepart" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*eng/list-sparepart*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li class="relative">
            <button 
              ...
              class="w-full group flex items-center justify-between rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*eng/in*', '*eng/out*', '*eng/disposal*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}"
            >
          ...
          <li>
            <a href="/eng/purchase-request" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*eng/purchase-request*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li>
            <a href="/eng/report" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*eng/report*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
      ...
      <div class="mb-8" x-data="{ 
        openMenuProd: '{{ request()->is('*prod/transaction*', '*transaction/in*', '*transaction/out*') ? 'trans' : (request()->is('*prod/request*', '*request/create*', '*request/list*', '*prod/history*') ? 'request' : 'none') }}'
      }">
        <h3 x-show="!sidebarToggle || window.innerWidth < 1024" class="mb-4 ml-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">
          PRODUCTION
        </h3>
        ...
        <ul class="flex flex-col gap-1.5">
          <li>
            <a href="/prod/overview" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*prod/overview*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li>
            <a href="/prod/list-sparepart" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*prod/list-sparepart*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li>
            <a href="/prod/stock" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*prod/stock*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
          ...
          <li>
            <a href="/prod/history" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*prod/history*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
              <svg class="siix-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
              <span x-show="!sidebarToggle || window.innerWidth < 1024">History Request</span>
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="mb-8">
        ...
        <ul class="flex flex-col gap-1.5">
          ...
          <li>
            <a href="{{ route('costing.incoming.pr') }}" class="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-semibold transition-all {{ request()->is('*costing/incoming*') ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-800' }}">
