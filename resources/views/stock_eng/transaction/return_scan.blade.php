    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8 panel-box flex flex-col">
            <div class="border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 rounded-t-xl">
                <h3 class="font-semibold text-slate-800 dark:text-white text-sm">Hardware Lensa Live (Return Mode)</h3>
        ...
        <div class="lg:col-span-4 flex flex-col gap-6">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed" id="status-desc">
                                Jalankan lensa kamera atau gunakan input manual untuk mengeksekusi pengembalian barang ke rak.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-box flex flex-col">
                ...
                <div class="p-5 flex flex-col gap-4">
                    <div>
                        <label class="block text-[10px] font-bold text-slate-500 uppercase mb-1">Ketik / Tembak Barcode ID Return</label>
...
<script>
    ...
    // FUNGSI INTI AJAX SUBMIT SCAN RETURN
