...
<div class="-m-4 md:-m-6 2xl:-m-10 bg-slate-50 dark:bg-boxdark-2 min-h-[calc(100vh-80px)]">
    ...
    <div class="p-4 md:p-8 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-slate-900 dark:text-white">
            <div>
                <h1 class="text-2xl font-bold tracking-tight uppercase">Spareparts</h1>
                <nav class="flex text-sm text-slate-500 font-medium mt-1">
                    <span>Engineering</span>
                    <span class="mx-2 text-slate-300">/</span>
                    <span class="text-primary font-bold">Master Data</span>
                </nav>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-boxdark rounded-2xl border border-slate-200 dark:border-strokedark shadow-sm overflow-hidden">
            ...
            <div class="p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-100 dark:border-strokedark">
                <div>
                    ...
                    <p class="text-sm text-slate-500 font-bold uppercase tracking-tight mt-1">Manage machine nozzle and engineering stock.</p>
                </div>
                ...
                <table class="w-full text-left border-collapse min-w-[800px]">
                    <thead>
                        <tr class="border-y border-slate-100 dark:border-strokedark bg-slate-50/50 dark:bg-meta-4/20">
                            ...
                            <th class="px-6 py-4 text-xs font-black text-slate-500 uppercase tracking-widest text-center">Stock</th>
                            <th class="px-6 py-4 text-xs font-black text-slate-500 uppercase tracking-widest text-center">Update At</th>
                    ...
                    <tbody class="divide-y divide-slate-50 dark:divide-strokedark font-bold">
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-meta-4/10 transition-all">
                            ...
                            <td class="px-6 py-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Line SMT 01</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-6 text-center">
                                <span class="px-3 py-1 rounded-full text-[10px] font-black bg-emerald-50 text-emerald-600 border border-emerald-100 uppercase">In Stock</span>
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-meta-4/10 transition-all">
                            ...
                            <td class="px-6 py-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Line SMT 02</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-6 text-center">
                                <span class="px-3 py-1 rounded-full text-[10px] font-black bg-rose-50 text-rose-600 border border-rose-100 uppercase">Out of Stock</span>
                            </td>
