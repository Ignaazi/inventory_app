...
<head>
    ...
    <style>
        /* Animasi pergerakan gradasi pelangi biru cerah agar dinamis dan hidup */
        @keyframes vibrantBlueRainbow {
        ...
        .animate-rainbow {
            ...
            animation: vibrantBlueRainbow 8s ease-in-out infinite;
        }
    </style>
</head>
<body class="h-screen flex font-sans overflow-hidden bg-white relative">
    ...
    <script>
        // Fungsi Menutup Pop-up Modal Error
        function closeModal() {
        ...
        // --- ENGINES FOR 3D PARTICLES EFFECT ---
        const canvas = document.getElementById('particleCanvas');
        const ctx = canvas.getContext('2d');

        let particlesArray = [];
        const numberOfParticles = 45; // Jumlah bintik biar pas, tidak terlalu ramai

        // Set ukuran canvas agar pas mengikuti kontainer
        ...
        // Blueprint objek Bintik Partikel
        class Particle {
            constructor() {
        ...
        // Looping Animasi secara Real-time
        function animate() {
