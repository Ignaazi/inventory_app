      ...
      <table class="min-w-full text-left border-collapse" id="history-table">
        <thead>
          <tr class="border-gray-100 border-y dark:border-gray-800 bg-gray-50/50 dark:bg-slate-800/40">
            ...
            <th class="py-3 px-3 text-xs font-bold text-slate-950 uppercase dark:text-white">LINE TARGET</th>
            ...
            <th class="py-3 px-3 text-xs font-bold text-slate-950 uppercase dark:text-white text-center">QTY IN</th>
            ...
            <th class="py-3 px-3 text-xs font-bold text-slate-950 uppercase dark:text-white">UPDATED AT</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          @if(isset($history) && count($history) > 0)
            ...
            <tr class="table-row-item hover:bg-gray-50/50 transition-colors duration-200 dark:hover:bg-white/[0.02]">
              ...
              {{-- Semua text reguler diganti ke text-xs dengan warna solid text-slate-950 / text-slate-700 --}}
              ...
              <td class="py-3 px-3 text-xs font-semibold text-slate-950 dark:text-white whitespace-nowrap">
                {{ $log->created_at ? ($log->created_at instanceof \Carbon\Carbon ? $log->created_at->format('d/m/Y H:i') : \Carbon\Carbon::parse($log->created_at)->format('d/m/Y H:i')) : '-' }}
              </td>
              ...
              {{-- Bungkusan kotak Qty In --}}
              <td class="py-3 px-3 text-center">
                <span class="inline-flex items-center justify-center rounded border border-emerald-300 bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-900 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-400">
                  +{{ $log->qty_in ?? 0 }}
                </span>
              </td>
              ...
              <td class="py-3 px-3 text-xs font-semibold text-slate-950 dark:text-slate-400 whitespace-nowrap font-mono">
                {{ $log->created_at ? ($log->created_at instanceof \Carbon\Carbon ? $log->created_at->toDateTimeString() : $log->created_at) : '-' }}
              </td>

              <td class="py-3 px-3 text-xs font-semibold text-slate-950 dark:text-slate-400 whitespace-nowrap font-mono">
                {{ $log->updated_at ? ($log->updated_at instanceof \Carbon\Carbon ? $log->updated_at->toDateTimeString() : $log->updated_at) : '-' }}
              </td>
            </tr>
            @endforeach
