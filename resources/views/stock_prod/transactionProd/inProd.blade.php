...
<div class="-m-4 md:-m-6 2xl:-m-10 bg-slate-50 dark:bg-boxdark-2 min-h-[calc(100vh-80px)] font-sans">
    ...
    <div class="p-4 md:p-8 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-slate-900 dark:text-white">
            <div>
                <h1 class="text-2xl font-black tracking-tight uppercase">Production In</h1>
                <nav class="flex text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1">
                    <span>Production</span>
                    <span class="mx-2 text-slate-300">/</span>
                    <span class="text-emerald-600 font-bold uppercase">Stock Receiving</span>
                </nav>
            </div>
        ...
        <div class="mb-6 bg-white dark:bg-boxdark rounded-2xl border border-slate-200 dark:border-strokedark shadow-sm p-6">
            <div class="flex flex-col md:flex-row items-center gap-6">
                <div class="w-full md:w-1/4 flex flex-col items-center justify-center p-6 border-2 border-dashed border-emerald-100 dark:border-strokedark rounded-2xl bg-emerald-50/20 dark:bg-meta-4/10">
                    <svg class="w-16 h-16 text-emerald-500 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M3 7V5a2 2 0 012-2h2m10 0h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2M7 12h10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span class="text-[10px] font-black uppercase text-emerald-600 tracking-widest">Ready to Scan</span>
                </div>

                <div class="w-full md:w-3/4 flex flex-col gap-4">
                    <div>
                        <label class="block text-xs font-black uppercase text-slate-500 mb-2 tracking-widest">Scan Part From Engineering</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-4 flex items-center text-emerald-600">
                            ...
                            <input type="text" autofocus placeholder="PLEASE SCAN BARCODE HERE..." 
                                class="w-full pl-12 pr-4 py-4 bg-slate-50 dark:bg-meta-4 border border-slate-100 dark:border-strokedark rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all text-sm font-black uppercase tracking-widest">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-2">
                        ...
                        <button class="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-emerald-100 dark:shadow-none transition-all">
                            Receive Stock
                        </button>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-boxdark rounded-2xl border border-slate-200 dark:border-strokedark shadow-sm overflow-hidden text-slate-900 dark:text-white">
            ...
            <div class="p-6 border-b border-slate-100 dark:border-strokedark flex justify-between items-center bg-white dark:bg-boxdark">
                <div>
                    <h3 class="text-lg font-bold uppercase tracking-tight">Recent Inbound Log</h3>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">History of received items from engineering department.</p>
                </div>
                ...
                <table class="w-full text-left border-collapse min-w-[800px]">
                    <thead>
                        <tr class="border-y border-slate-100 dark:border-strokedark bg-slate-50/50 dark:bg-meta-4/20">
                            <th class="px-6 py-4 text-xs font-black text-slate-500 uppercase tracking-widest">Time Received</th>
                            ...
                            <th class="px-6 py-4 text-xs font-black text-slate-500 uppercase tracking-widest text-center">Qty In</th>
                            <th class="px-6 py-4 text-xs font-black text-slate-500 uppercase tracking-widest text-center">Receiver</th>
                    ...
                    <tbody class="divide-y divide-slate-50 dark:divide-strokedark font-bold">
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-meta-4/5 transition-all">
                            <td class="px-6 py-6 text-[10px] text-slate-400 font-black uppercase tracking-tighter">
                                21:15:30<br><span class="text-[8px]">31 Mar 2026</span>
                            </td>
                            <td class="px-6 py-6">
                                <div class="flex flex-col">
                                    <span class="text-sm font-black text-slate-800 dark:text-white uppercase">Nozzle Yamaha 221</span>
                                    <span class="text-[9px] text-emerald-600 uppercase tracking-widest mt-0.5">Line SMT 01</span>
                                </div>
                            </td>
                            <td class="px-6 py-6 text-center">
                                <span class="bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 px-3 py-1 rounded text-[10px] font-black uppercase">SAP-NOZ-YMH01</span>
                            </td>
                            <td class="px-6 py-6 text-center text-sm font-black text-emerald-600">
                                + 20 PCS
                            </td>
                            ...
                            <td class="px-6 py-6 text-center">
                                <span class="px-3 py-1 rounded-full text-[9px] font-black bg-emerald-50 text-emerald-600 border border-emerald-100 uppercase tracking-widest">Received</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="p-6 flex flex-col md:flex-row justify-between items-center gap-4 border-t border-slate-50 dark:border-strokedark bg-white dark:bg-boxdark">
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <button class="w-8 h-8 flex items-center justify-center bg-emerald-600 rounded-lg text-white text-[10px] font-black">1</button>
